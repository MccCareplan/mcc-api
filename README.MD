...
In the default configuration the profiles that are provided are: [dfefault], dev and prod. 
...
details on Spring boot.
 ...
 | -------------- | ---------------------- | ---------------- | --------- | ------ |
| server.port | SERVER_PORT | The port on whihc tomcat runs | 8081 | Tomcat Def (8080) |
